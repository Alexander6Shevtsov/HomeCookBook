...
Загружает рецепты из открытого API [TheMealDB](https://www.themealdb.com), показывает список блюд, детали рецепта, позволяет искать и сохранять в избранное.
...
- Кэширование:
  ...
  - предзагрузка изображений при пролистывании списков
